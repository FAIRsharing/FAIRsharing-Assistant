...
&lt;img src="https://api.fairsharing.org/img/fairsharing-attribution.svg" alt="FAIRsharing Logo"&gt;</pre
      ...
      >
        ...
        projects, extending the vocabulary of tags to annotate our content. We
        will mark up FAIRsharing content with these tags in the near future.
      </p>
      ...
      >
        Please do not scrape the HTML page content. Much of the data is
        generated dynamically and is updated daily. Instead, please use our API
        or contact us directly and ask for a cut of the data. We're friendly and
        don't bite.
      </p>
    </main>
  </div>
