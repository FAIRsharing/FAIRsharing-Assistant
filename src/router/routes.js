...
export const ResourceTypeView = () => import('@/views/Resource/ResourceTypeView.vue');
export const SubjectTypeView = () => import('@/views/Subject/SubjectTypeView.vue');
// export const SubjectTypeView_1 = () => import('@/views/Subject/SubjectTypeView_1.vue');
export const DomainTypeView = () => import('@/views/Domain/DomainTypeView.vue');
export const DomainTypeViewD3JS = () => import('@/views/Domain/DomainTypeView_D3JS.vue');
