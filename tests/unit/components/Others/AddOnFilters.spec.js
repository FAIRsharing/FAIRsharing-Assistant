  ...
  switch: [
    {
      ...
      refineToggle: false,
      filterTypes: ["Mock_database"],
      tooltip:
        "Mock_Does this resource implement any identifier schema standard?",
    },
  ],
  select: [
    {
      ...
      filterTypes: ["Mock_database", "Mock_standards", "Mock_policies"],
      tooltip:
        "Mock_An indication of whether the resource is currently maintained/supported.",
    },
  ],
};
