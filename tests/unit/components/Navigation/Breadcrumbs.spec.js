...
navigationStore.getters = {
  ...
  getRole:() => { return "Researcher" },
  getRestrict:() => { return "database" },
}
...
describe("Breadcrumbs.vue", function(){
  ...
  it("can check formatBreadcrumb method when parameter includes text 'POLICY'", () => {
    ...
    navigationStore.getters = {
      getCompliantWith: () => { return "GenbankSequenceFormat" },
      getCompliantWithPolicy: () => { return "Nature Genetics, test1, test2" },
      getRole:() => { return "Researcher" },
      getRestrict:() => { return "database" },
    }
    store = createStore({
  ...
  it("can check getSummaryText method when text from summaries.json includes 'STANDARD_4'", () => {
    ...
    let outputText = "You have selected the following relevant standards <b>GenbankSequenceFormat</b>"
  ...
  it("can check getSummaryText method when text from summaries.json includes 'STANDARD_4' but does not have value in getCompliantWith getter", () => {
    ...
    let outputText = "You have not selected any relevant standards for your data"
  ...
  it("can check getSummaryText method when text from summaries.json includes 'ROLE' having values for getRole and getRestrict getters", () => {
    ...
    let outputText = "The FAIRsharing Assistant is set to the <b>Researcher</b> role. We have restricted the available databases to those appropriate for data deposition, which means they: are repositories or knowledgebases/repositories, have a life cycle status of Ready or In development."
  ...
  it("can check getSummaryText method when text from summaries.json includes 'ROLE' does not have values for getRestrict getters", () => {
    ...
    let outputText = "The FAIRsharing Assistant is set to the <b>Researcher</b> role."
  ...
  it("can check prepareFilterSummary method", () => {
    ...
    expect(wrapper.vm.prepareFilterSummary()).toBe("Subjects: genetics<br>Registry: standard<br>");
  });
